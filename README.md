...
sections [/doc/nicolo-howto-talk/privatename.md](/doc/nicolo-howto-talk/privatename.md) and [/src/record-and-tuple](/src/record-and-tuple.md). This tutorial is a collection of notes and examples on how to use Babel to extend JavaScript syntax and semantics. 
