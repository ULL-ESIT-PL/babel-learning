...
This section shows a snippet of the `parseSubscript` method in the Babel parser that deals with parsing subscript expressions, including optional chaining which was a new feature at the time of Nicolas' talk [@babel/howto](https://youtu.be/UeVq_U5obnE?t=3119). 
