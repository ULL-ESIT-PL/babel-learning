...
This is not affected by semicolon insertion (see [112.10.1 Rules of Automatic Semicolon Insertion](https://tc39.es/ecma262/#sec-rules-of-automatic-semicolon-insertion); in examples such as lines 4 and 5 in the following code:
